...
public class EnterMarks extends JFrame implements ActionListener {
    ...
    EnterMarks() {
        ...
        tfmarks1.setBounds(252, 200, 200,20);
        add(tfmarks1);
        
        tfmarks2 = new JTextField();
        tfmarks2.setBounds(252, 230, 200,20);
        add(tfmarks2);
        
        tfmarks3 = new JTextField();
        tfmarks3.setBounds(252, 260, 200,20);
        add(tfmarks3);
        
        tfmarks4 = new JTextField();
        tfmarks4.setBounds(252, 290, 200,20);
        add(tfmarks4);
        
        tfmarks5 = new JTextField();
        tfmarks5.setBounds(252, 320, 200,20);
        add(tfmarks5);
        ...
        cancel.setBounds(260, 380, 150, 25);
